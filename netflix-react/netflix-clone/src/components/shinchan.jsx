...
import styles from "./shinchan.module.css";
import text from "../assets/shinchantext.png";
...
const Shinchan = () => {
  ...
  const handleWatchNow = () => {
    const movieId = "67b578a7252a7539a59d9b23"; // Unique Movie ID
    const driveFileId = "1Qz9jfIqT6mCXj3rwzvv3rav3zQjrCpqB"; // Replace with actual Google Drive File ID
  ...
  return (
    <div className={styles.background}>
      ...
      <div className={styles.content}>
        {!isPlaying ? (
          <>
            <img className={styles.image} src={text} alt="Shinchan" />
            ...
            <p className={styles.description}>
              Shinchan is a Japanese animated series that follows the mischief of a
              five-year-old boy named Shinchan, whose playful
              pranks often get him into trouble.
            </p>
            {/* Watch Now Button */}
